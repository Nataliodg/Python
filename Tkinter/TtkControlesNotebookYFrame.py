#La clase Notebook nos permite crear un cuaderno con una serie de pestañas en la parte superior.
# En cada pestaña asociamos un objeto de la clase Frame y dentro de esta podemos disponer distintos
# controles visuales que hemos visto hasta ahora como pueden ser Label, Button, Radiobutton, Checkbutton,
# Entry etc.

#1)
#Confeccionar una aplicación que muestre un cuaderno con tres pestañas.
# Los títulos de cada pestaña deben ser 'Button', 'Label' y 'Entry'.
